...
import torch
from code.render import generate_gif_from_voxels,generate_gif_from_point,generate_gif_from_mesh
...
def fit_mesh(mesh_src, mesh_tgt, args, device):
    ...
    generate_gif_from_mesh(mesh_tgt,'images/mesh_render_gt.gif')
    print('Rendering Prediction')
    generate_gif_from_mesh(mesh_src,'images/mesh_render.gif')
...
def fit_pointcloud(pointclouds_src, pointclouds_tgt, args):
    ...
    print('Done!')
    print('Rendering Ground Truth')
    generate_gif_from_point(pointclouds_tgt,path='images/point_render_gt.gif')
    print('Rendering Prediction')
    generate_gif_from_point(pointclouds_src,path='images/point_render.gif')
...
def fit_voxel(voxels_src, voxels_tgt, args):
    ...
    print('Done!')
    print('Rendering Ground Truth')
    generate_gif_from_voxels(voxels_tgt,path='images/voxel_render_gt.gif')
    print('Rendering Prediction')
    generate_gif_from_voxels(voxels_tgt,path='images/voxel_render.gif')
