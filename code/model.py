...
class SingleViewto3D(nn.Module):
    def __init__(self, args):
        ...
        if args.type == "vox":
            ...
            # print("Decoder Model is on device:", next(self.decoder.parameters()).device)
            ...
            nn.Linear(2048, 2048),
            nn.ReLU(),
            nn.Linear(2048, mesh_pred.verts_packed().shape[0]*3)  # Output N*3 values for N points in 3D
            )
            # print("Decoder Model is on device:", next(self.decoder.parameters()).device)
